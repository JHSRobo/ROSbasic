...
def talker():
	...
	while not rospy.is_shutdown():
		...
		angular_velocity_roll = (orientation['yaw'] - start_roll) / (elapsed_time)
		angular_velocity_pitch = (orientation['roll'] - start_pitch) / (elapsed_time)
		angular_velocity_yaw = (orientation['pitch'] - start_yaw) / (elapsed_time)
